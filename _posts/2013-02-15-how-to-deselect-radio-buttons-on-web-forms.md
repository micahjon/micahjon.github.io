...
![Original Form]({{site.baseurl}}/assets/Screen Shot 2016-10-30 at 7.34.51 PM.png)
...
![Filling in multiple radio buttons]({{site.baseurl}}/assets/Screen Shot 2016-10-30 at 7.37.30 PM.png)
...
![Right click on radio button, Inspect]({{site.baseurl}}/assets/Screen Shot 2016-10-30 at 7.38.46 PM.png)

2.  Notice the <input> tag that represents this radio button has a unique id of "choice_31_8_0". 

![Highlighted tag refers to this radio button]({{site.baseurl}}/assets/Screen Shot 2016-10-30 at 7.46.05 PM.png)

Double click to select this id, and copy it.

![Double click id to select the unique id of the radio button]({{site.baseurl}}/assets/Screen Shot 2016-10-30 at 7.48.01 PM.png)
...
![In Console tab, paste the above javascript snippet]({{site.baseurl}}/assets/Screen Shot 2016-10-30 at 9.43.41 PM.png)

4.  Press enter to run code! This should deselect your radio button. 

![Press enter to run code. Radio button should be deselected]({{site.baseurl}}/assets/Screen Shot 2016-10-30 at 9.45.18 PM.png)
