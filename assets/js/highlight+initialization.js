...
end:/(?=#)|$/,contains:[b,o,r]},{begin:/\b(print|exec)\(/}]}}})());hljs.registerLanguage("xml",(()=>{"use strict";function e(e){
...
begin:/>/,relevance:0}]}]}}})());hljs.registerLanguage("twig",(()=>{"use strict";return e=>{
...
begin:/\{\{/,end:/\}\}/,contains:["self",t,n]}]}}})());hljs.registerLanguage("sql",(()=>{"use strict";return e=>{
...
},e.C_BLOCK_COMMENT_MODE,t,e.HASH_COMMENT_MODE]}}})());hljs.registerLanguage("json",(()=>{"use strict";return n=>{const e={
...
illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,{begin:/;/},a]}]}}})());hljs.registerLanguage("handlebars",(()=>{"use strict";function e(...e){
...
className:"template-variable",begin:/\{\{/,end:/\}\}/,contains:[h]}]}}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
...
}],illegal:/\S/}}})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
 ...
 */
!function() {
  var ric = requestIdleCallback || setTimeout;
  ...
  function highlightBlock(index) {
    ric(function() {
      if (blocks[index]) {
        var content = blocks[index].textContent; //.split('\n').map(line => line.length)
        // .reduce(function(max, len) {
        //   return Math.max(max, len)
        // }, 0);
        console.log('Max line length', content)

        // hljs.highlightBlock(blocks[index]);
        if (blocks[index].className.indexOf('-bash') === -1) {
          blocks[index].className += ' long-code-block';
        }
